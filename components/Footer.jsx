    ...
    <footer className="bg-gray-50 dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-400 text-sm">
              Expert insights on finance, technology, and business. Join thousands of readers staying informed.
            </p>
            <div className="mt-6 flex space-x-4">
              <a
                href="https://x.com/robinfelix123?s=21"
                target="_blank"
              ...
              <a
                href="https://www.facebook.com/share/1AmfEsqGw2/?mibextid=wwXIfr"
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400"
                aria-label="Facebook"
        ...
        <div className="mt-8 border-t border-gray-200 dark:border-gray-800 pt-8 text-center">
            ...
            © {currentYear} ZEE BlOG. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
